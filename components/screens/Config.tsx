    ...
    <div className="flex flex-col flex-1 min-h-0">
      <div className="px-5 pt-1 pb-28 flex flex-col gap-5.5 flex-1">
        {cfg.isCustomName ? (
          <input
            autoFocus
            value={cfg.exerciseName}
            onChange={(e) => setCfg({ exerciseName: e.target.value })}
            placeholder="Nome do exercício"
            className="font-serif text-2xl text-ink bg-transparent border-b border-border px-0 py-1 focus:outline-none"
          />
        ) : (
